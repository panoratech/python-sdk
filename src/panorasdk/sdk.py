...
from .services.ticketing_comment import TicketingComment
...
class PanoraSDK:
    ...
    projects : Projects
    protected : Protected
    ticketing_comment : TicketingComment
    ...
    def __init__(self, access_token="", environment=Environment.DEFAULT) -> None:
        ...
        self.ticketing_comment = TicketingComment(access_token)
    ...
    def set_base_url(self, url: str) -> None:
        ...
        self.ticketing_comment.set_base_url(url)
    ...
    def set_access_token(self, token: str) -> None:
        ...
        self.ticketing_comment.set_access_token(token)
