...
class Companyinfos(BaseSDK):
    ...
    def list(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listAccountingCompanyInfos", oauth2_scopes=[], security_source=None),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListAccountingCompanyInfosResponseBody])
    ...
    def retrieve(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveAccountingCompanyInfo", oauth2_scopes=[], security_source=None),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
