...
class Taxrates(BaseSDK):
    ...
    def list(
    ...
    ) -> Optional[models.ListAccountingTaxRateResponseBody]:
        r"""List  TaxRates
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listAccountingTaxRate", oauth2_scopes=[], security_source=None),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListAccountingTaxRateResponseBody])
    ...
    def retrieve(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveAccountingTaxRate", oauth2_scopes=[], security_source=None),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
