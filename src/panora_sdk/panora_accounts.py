...
class PanoraAccounts(BaseSDK):
    ...
    def list(
    ...
    ) -> Optional[models.ListAccountingAccountsResponseBody]:
        r"""List  Accounts
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listAccountingAccounts", oauth2_scopes=[], security_source=None),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListAccountingAccountsResponseBody])
    ...
    def create(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="createAccountingAccount", oauth2_scopes=[], security_source=None),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
    ...
    def retrieve(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveAccountingAccount", oauth2_scopes=[], security_source=None),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
