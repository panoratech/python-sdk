...
class Payrollruns(BaseSDK):
    ...
    def list(
    ...
    ) -> Optional[models.ListHrisPayrollRunsResponseBody]:
        r"""List  PayrollRuns
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listHrisPayrollRuns", oauth2_scopes=[], security_source=None),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListHrisPayrollRunsResponseBody])
