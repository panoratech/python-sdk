...
class ListHrisTimeoffbalanceRequestTypedDict(TypedDict):
...
class ListHrisTimeoffbalanceRequest(BaseModel):
...
class ListHrisTimeoffbalanceResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisTimeoffbalanceOutputTypedDict]
    

class ListHrisTimeoffbalanceResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
