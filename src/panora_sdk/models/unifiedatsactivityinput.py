...
class UnifiedAtsActivityInputActivityType(str, Enum):
    r"""The type of activity"""
    NOTE = "NOTE"
    EMAIL = "EMAIL"
    OTHER = "OTHER"

class UnifiedAtsActivityInputVisibility(str, Enum):
...
class UnifiedAtsActivityInputTypedDict(TypedDict):
    activity_type: NotRequired[Nullable[UnifiedAtsActivityInputActivityType]]
    r"""The type of activity"""
    subject: NotRequired[Nullable[str]]
    r"""The subject of the activity"""
    body: NotRequired[Nullable[str]]
    r"""The body of the activity"""
    visibility: NotRequired[Nullable[UnifiedAtsActivityInputVisibility]]
    r"""The visibility of the activity"""
...
class UnifiedAtsActivityInput(BaseModel):
    activity_type: OptionalNullable[UnifiedAtsActivityInputActivityType] = UNSET
    r"""The type of activity"""
    subject: OptionalNullable[str] = UNSET
    r"""The subject of the activity"""
    body: OptionalNullable[str] = UNSET
    r"""The body of the activity"""
    visibility: OptionalNullable[UnifiedAtsActivityInputVisibility] = UNSET
    r"""The visibility of the activity"""
