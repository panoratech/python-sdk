...
class ListFilestorageDrivesResponseTypedDict(TypedDict):
    result: ListFilestorageDrivesResponseBodyTypedDict
    

class ListFilestorageDrivesResponse(BaseModel):
    next: Callable[[], Optional[ListFilestorageDrivesResponse]]
