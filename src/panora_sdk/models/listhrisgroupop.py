...
class ListHrisGroupRequestTypedDict(TypedDict):
...
class ListHrisGroupRequest(BaseModel):
...
class ListHrisGroupResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisGroupOutputTypedDict]
    

class ListHrisGroupResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
