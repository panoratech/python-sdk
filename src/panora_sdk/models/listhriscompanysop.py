...
class ListHrisCompanysRequestTypedDict(TypedDict):
...
class ListHrisCompanysRequest(BaseModel):
...
class ListHrisCompanysResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedHrisCompanyOutputTypedDict]
    

class ListHrisCompanysResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
