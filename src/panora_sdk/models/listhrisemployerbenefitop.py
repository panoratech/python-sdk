...
class ListHrisEmployerBenefitRequestTypedDict(TypedDict):
...
class ListHrisEmployerBenefitRequest(BaseModel):
...
class ListHrisEmployerBenefitResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedHrisEmployerbenefitOutputTypedDict]
    

class ListHrisEmployerBenefitResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
