...
class UnifiedCrmCompanyInputIndustry(str, Enum):
...
class UnifiedCrmCompanyInputTypedDict(TypedDict):
    ...
    industry: NotRequired[Nullable[UnifiedCrmCompanyInputIndustry]]
    r"""The industry of the company. Authorized values can be found in the Industry enum."""
...
class UnifiedCrmCompanyInput(BaseModel):
    name: Nullable[str]
    r"""The name of the company"""
    industry: OptionalNullable[UnifiedCrmCompanyInputIndustry] = UNSET
    r"""The industry of the company. Authorized values can be found in the Industry enum."""
