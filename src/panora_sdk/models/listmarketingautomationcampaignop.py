...
from .unifiedcampaignoutput import UnifiedCampaignOutput, UnifiedCampaignOutputTypedDict
...
class ListMarketingautomationCampaignRequestTypedDict(TypedDict):
...
class ListMarketingautomationCampaignRequest(BaseModel):
...
class ListMarketingautomationCampaignResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedCampaignOutputTypedDict]
    

class ListMarketingautomationCampaignResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedCampaignOutput]
