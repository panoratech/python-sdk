...
class Drives(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListFilestorageDrivesResponse:
        r"""List Drives
        ...
        request = models.ListFilestorageDrivesRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listFilestorageDrives", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        
        def next_func() -> Optional[models.ListFilestorageDrivesResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListFilestorageDrivesResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListFilestorageDrivesResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        request = models.RetrieveFilestorageDriveRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveFilestorageDrive", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedFilestorageDriveOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
