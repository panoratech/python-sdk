...
class Drives(BaseSDK):
    ...
    def list(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listFilestorageDrives", oauth2_scopes=[], security_source=None),
            request=req,
    ...
    def retrieve(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveFilestorageDrive", oauth2_scopes=[], security_source=None),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
