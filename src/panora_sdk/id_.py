...
class ID(BaseSDK):
    ...
    def delete(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="delete", oauth2_scopes=[], security_source=None),
            request=req,
    ...
    def update_status(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="updateStatus", oauth2_scopes=[], security_source=None),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
