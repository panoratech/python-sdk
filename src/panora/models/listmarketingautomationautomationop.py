...
class ListMarketingautomationAutomationRequestTypedDict(TypedDict):
...
class ListMarketingautomationAutomationRequest(BaseModel):
...
class ListMarketingautomationAutomationResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedMarketingautomationAutomationOutputTypedDict]
    

class ListMarketingautomationAutomationResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
