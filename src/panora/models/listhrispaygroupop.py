...
class ListHrisPaygroupRequestTypedDict(TypedDict):
...
class ListHrisPaygroupRequest(BaseModel):
...
class ListHrisPaygroupResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedHrisPaygroupOutputTypedDict]
    

class ListHrisPaygroupResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
