...
class ListHrisEmploymentRequestTypedDict(TypedDict):
...
class ListHrisEmploymentRequest(BaseModel):
...
class ListHrisEmploymentResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedHrisEmploymentOutputTypedDict]
    

class ListHrisEmploymentResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
