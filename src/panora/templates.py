...
class Templates(BaseSDK):
    ...
    def list(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListMarketingautomationTemplatesResponseBody])
    ...
    def create(
        ...
        request = models.CreateMarketingautomationTemplateRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_marketingautomation_template_input=utils.unmarshal(unified_marketingautomation_template_input, models.UnifiedMarketingautomationTemplateInput) if not isinstance(unified_marketingautomation_template_input, BaseModel) else unified_marketingautomation_template_input,
        )
