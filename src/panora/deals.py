...
class Deals(BaseSDK):
    ...
    def create(
        ...
        request = models.CreateCrmDealRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_crm_deal_input=utils.unmarshal(unified_crm_deal_input, models.UnifiedCrmDealInput) if not isinstance(unified_crm_deal_input, BaseModel) else unified_crm_deal_input,
        )
