...
class PanoraCompanies(BaseSDK):
    ...
    def list(
    ...
    ) -> Optional[models.ListHrisCompanysResponseBody]:
        r"""List  Companys
        ...
        request = models.ListHrisCompanysRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listHrisCompanys", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListHrisCompanysResponseBody])
