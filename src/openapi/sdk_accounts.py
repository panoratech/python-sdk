...
class SDKAccounts(BaseSDK):
    ...
    def create(
        ...
        request = models.CreateAccountingAccountRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_accounting_account_input=utils.unmarshal(unified_accounting_account_input, models.UnifiedAccountingAccountInput) if not isinstance(unified_accounting_account_input, BaseModel) else unified_accounting_account_input,
        )
