...
class SDKMarketingautomationContacts(BaseSDK):
    ...
    def list(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListMarketingAutomationContactsResponseBody])
    ...
    def create(
        ...
        request = models.CreateMarketingAutomationContactRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_marketingautomation_contact_input=utils.unmarshal(unified_marketingautomation_contact_input, models.UnifiedMarketingautomationContactInput) if not isinstance(unified_marketingautomation_contact_input, BaseModel) else unified_marketingautomation_contact_input,
        )
