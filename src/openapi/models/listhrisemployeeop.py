...
class ListHrisEmployeeRequestTypedDict(TypedDict):
...
class ListHrisEmployeeRequest(BaseModel):
...
class ListHrisEmployeeResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedHrisEmployeeOutputTypedDict]
    

class ListHrisEmployeeResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
