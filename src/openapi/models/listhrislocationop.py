...
class ListHrisLocationRequestTypedDict(TypedDict):
...
class ListHrisLocationRequest(BaseModel):
...
class ListHrisLocationResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedHrisLocationOutputTypedDict]
    

class ListHrisLocationResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
