...
class ListHrisBenefitRequestTypedDict(TypedDict):
...
class ListHrisBenefitRequest(BaseModel):
...
class ListHrisBenefitResponseBodyTypedDict(TypedDict):
    prev_cursor: str
    next_cursor: str
    data: List[UnifiedHrisBenefitOutputTypedDict]
    

class ListHrisBenefitResponseBody(BaseModel):
    prev_cursor: str
    next_cursor: str
