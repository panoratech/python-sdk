...
class SDKAttachments(BaseSDK):
    ...
    def create(
        ...
        request = models.CreateAccountingAttachmentRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_accounting_attachment_input=utils.unmarshal(unified_accounting_attachment_input, models.UnifiedAccountingAttachmentInput) if not isinstance(unified_accounting_attachment_input, BaseModel) else unified_accounting_attachment_input,
        )
