...
class Candidates(BaseSDK):
    ...
    def create(
        ...
        request = models.CreateAtsCandidateRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_ats_candidate_input=utils.unmarshal(unified_ats_candidate_input, models.UnifiedAtsCandidateInput) if not isinstance(unified_ats_candidate_input, BaseModel) else unified_ats_candidate_input,
        )
