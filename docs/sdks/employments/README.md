...
**[models.ListHrisEmploymentsResponseBody](../../models/listhrisemploymentsresponsebody.md)**
### Errors
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `x_connection_token`                                                | *str*                                                               | :heavy_check_mark:                                                  | The connection token                                                |                                                                     |
| `id`                                                                | *str*                                                               | :heavy_check_mark:                                                  | id of the employment you want to retrieve.                          | 801f9ede-c698-4e66-a7fc-48d19eebaa4f                                |
...
**[models.UnifiedHrisEmploymentOutput](../../models/unifiedhrisemploymentoutput.md)**
### Errors
