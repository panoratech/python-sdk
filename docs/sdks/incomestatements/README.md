...
**[models.ListAccountingIncomeStatementResponseBody](../../models/listaccountingincomestatementresponsebody.md)**
### Errors
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `x_connection_token`                                                | *str*                                                               | :heavy_check_mark:                                                  | The connection token                                                |                                                                     |
| `id`                                                                | *str*                                                               | :heavy_check_mark:                                                  | id of the incomestatement you want to retrieve.                     | 801f9ede-c698-4e66-a7fc-48d19eebaa4f                                |
...
**[models.UnifiedAccountingIncomestatementOutput](../../models/unifiedaccountingincomestatementoutput.md)**
### Errors
