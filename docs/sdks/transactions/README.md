...
**[models.ListAccountingTransactionResponseBody](../../models/listaccountingtransactionresponsebody.md)**
### Errors
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `x_connection_token`                                                | *str*                                                               | :heavy_check_mark:                                                  | The connection token                                                |                                                                     |
| `id`                                                                | *str*                                                               | :heavy_check_mark:                                                  | id of the transaction you want to retrieve.                         | 801f9ede-c698-4e66-a7fc-48d19eebaa4f                                |
...
**[models.UnifiedAccountingTransactionOutput](../../models/unifiedaccountingtransactionoutput.md)**
### Errors
