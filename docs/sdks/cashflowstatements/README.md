...
**[models.ListAccountingCashflowStatementResponseBody](../../models/listaccountingcashflowstatementresponsebody.md)**
### Errors
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `x_connection_token`                                                | *str*                                                               | :heavy_check_mark:                                                  | The connection token                                                |                                                                     |
| `id`                                                                | *str*                                                               | :heavy_check_mark:                                                  | id of the cashflowstatement you want to retrieve.                   | 801f9ede-c698-4e66-a7fc-48d19eebaa4f                                |
...
**[models.UnifiedAccountingCashflowstatementOutput](../../models/unifiedaccountingcashflowstatementoutput.md)**
### Errors
