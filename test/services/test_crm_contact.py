...
class TestCrmContact_(unittest.TestCase):
    ...
    def test_get_contacts(self):
        ...
        response = test_service.get_contacts("2892071469", "8546892793", True)
    ...
    def test_get_contacts_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = CrmContact("testkey")
            test_service.get_contacts("3742743514", "1340483724", True)
        responses.reset()
    ...
    def test_add_contact(self):
        ...
        # call the method to test
        test_service = CrmContact("testkey")
        response = test_service.add_contact({}, "7148163639", "2500635664", True)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_add_contact_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = CrmContact("testkey")
            test_service.add_contact({}, "3573785755", "5423964859", True)
        responses.reset()
    ...
    def test_update_contact(self):
        ...
        # call the method to test
        test_service = CrmContact("testkey")
        response = test_service.update_contact("6034906529")
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_update_contact_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = CrmContact("testkey")
            test_service.update_contact("8934420248")
        responses.reset()
    ...
    def test_get_contact(self):
        # Mock the API response
        responses.get(
            "https://api-demo.panora.dev/crm/contact/8410212986", json={}, status=200
        )
        # call the method to test
        test_service = CrmContact("testkey")
        response = test_service.get_contact("8410212986", True)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_contact_required_fields_missing(self):
        # Mock the API response
        responses.get(
            "https://api-demo.panora.dev/crm/contact/8262913819", json={}, status=202
        )
        with self.assertRaises(TypeError):
            test_service = CrmContact("testkey")
    ...
    def test_get_contact_error_on_non_200(self):
        # Mock the API response
        responses.get(
            "https://api-demo.panora.dev/crm/contact/9398285415", json={}, status=404
        )
        with self.assertRaises(ClientException):
            test_service = CrmContact("testkey")
            test_service.get_contact("9398285415", True)
        responses.reset()
    ...
    def test_add_contacts(self):
        ...
        # call the method to test
        test_service = CrmContact("testkey")
        response = test_service.add_contacts({}, "3208223798", "9916878885", True)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_add_contacts_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = CrmContact("testkey")
            test_service.add_contacts({}, "6202028139", "2431152370", True)
        responses.reset()
