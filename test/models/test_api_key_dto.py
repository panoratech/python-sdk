...
class TestApiKeyDtoModel(unittest.TestCase):
    ...
    def test_api_key_dto(self):
        ...
        test_model = ApiKeyDto(userId="aliquid", projectId="dolores", keyName="quasi")
        self.assertEqual(test_model.userId, "aliquid")
        self.assertEqual(test_model.projectId, "dolores")
        self.assertEqual(test_model.keyName, "quasi")
