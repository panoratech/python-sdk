...
class TestApiKeyDtoModel(unittest.TestCase):
    ...
    def test_api_key_dto(self):
        ...
        test_model = ApiKeyDto(
            keyName="aspernatur", userId="necessitatibus", projectId="doloribus"
        )
        self.assertEqual(test_model.keyName, "aspernatur")
        self.assertEqual(test_model.userId, "necessitatibus")
        self.assertEqual(test_model.projectId, "doloribus")
