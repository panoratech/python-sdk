...
class TestApiKeyDtoModel(unittest.TestCase):
    ...
    def test_api_key_dto(self):
        ...
        test_model = ApiKeyDto(userId="iste", projectId="et", keyName="possimus")
        self.assertEqual(test_model.userId, "iste")
        self.assertEqual(test_model.projectId, "et")
        self.assertEqual(test_model.keyName, "possimus")
