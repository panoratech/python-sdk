...
class TestLoginDtoModel(unittest.TestCase):
    ...
    def test_login_dto(self):
        ...
        test_model = LoginDto(password_hash="fuga", id_user="fugit", email="omnis")
        self.assertEqual(test_model.password_hash, "fuga")
        self.assertEqual(test_model.id_user, "fugit")
        self.assertEqual(test_model.email, "omnis")
