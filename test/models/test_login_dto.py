...
class TestLoginDtoModel(unittest.TestCase):
    ...
    def test_login_dto(self):
        ...
        test_model = LoginDto(password_hash="nemo", id_user="cumque", email="eius")
        self.assertEqual(test_model.password_hash, "nemo")
        self.assertEqual(test_model.id_user, "cumque")
