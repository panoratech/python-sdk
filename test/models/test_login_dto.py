...
class TestLoginDtoModel(unittest.TestCase):
    ...
    def test_login_dto(self):
        ...
        test_model = LoginDto(password_hash="velit", id_user="tenetur", email="quo")
        self.assertEqual(test_model.password_hash, "velit")
        self.assertEqual(test_model.id_user, "tenetur")
        self.assertEqual(test_model.email, "quo")
