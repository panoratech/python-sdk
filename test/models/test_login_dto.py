...
class TestLoginDtoModel(unittest.TestCase):
    ...
    def test_login_dto(self):
        ...
        test_model = LoginDto(password_hash="quae", id_user="labore", email="iure")
        self.assertEqual(test_model.password_hash, "quae")
        self.assertEqual(test_model.id_user, "labore")
        self.assertEqual(test_model.email, "iure")
