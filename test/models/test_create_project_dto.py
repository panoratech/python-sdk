...
class TestCreateProjectDtoModel(unittest.TestCase):
    ...
    def test_create_project_dto(self):
        ...
        test_model = CreateProjectDto(id_organization="illo", name="laudantium")
        self.assertEqual(test_model.id_organization, "illo")
        self.assertEqual(test_model.name, "laudantium")
