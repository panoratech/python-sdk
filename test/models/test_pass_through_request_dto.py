...
class TestPassThroughRequestDtoModel(unittest.TestCase):
    ...
    def test_pass_through_request_dto(self):
        ...
        test_model = PassThroughRequestDto(
            path="aperiam", method="GET", data={"corporis": 3}, headers_={"nisi": 6}
        )
        self.assertEqual(test_model.path, "aperiam")
        self.assertEqual(test_model.method, "GET")
        self.assertEqual(test_model.data, {"corporis": 3})
        self.assertEqual(test_model.headers_, {"nisi": 6})
