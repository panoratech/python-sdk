...
class TestPassThroughRequestDtoModel(unittest.TestCase):
    ...
    def test_pass_through_request_dto(self):
        ...
        test_model = PassThroughRequestDto(
            path="eum", method="GET", data={"delectus": 9}, headers_={"accusantium": 3}
        )
        self.assertEqual(test_model.path, "eum")
        self.assertEqual(test_model.method, "GET")
        self.assertEqual(test_model.data, {"delectus": 9})
        self.assertEqual(test_model.headers_, {"accusantium": 3})
