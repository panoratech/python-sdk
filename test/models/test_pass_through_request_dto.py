...
class TestPassThroughRequestDtoModel(unittest.TestCase):
    ...
    def test_pass_through_request_dto(self):
        ...
        test_model = PassThroughRequestDto(
            path="culpa", method="GET", data={"quod": 4}, headers_={"veritatis": 9}
        )
        self.assertEqual(test_model.path, "culpa")
        self.assertEqual(test_model.method, "GET")
        self.assertEqual(test_model.data, {"quod": 4})
        self.assertEqual(test_model.headers_, {"veritatis": 9})
