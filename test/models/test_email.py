...
class TestEmailModel(unittest.TestCase):
    ...
    def test_email(self):
        ...
        test_model = Email(
            email_address_type="assumenda", email_address="ad", owner_type="numquam"
        )
        self.assertEqual(test_model.email_address_type, "assumenda")
        self.assertEqual(test_model.email_address, "ad")
        self.assertEqual(test_model.owner_type, "numquam")
