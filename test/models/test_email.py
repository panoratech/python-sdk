...
class TestEmailModel(unittest.TestCase):
    ...
    def test_email(self):
        ...
        test_model = Email(
            email_address_type="quos", email_address="ullam", owner_type="quidem"
        )
        self.assertEqual(test_model.email_address_type, "quos")
        self.assertEqual(test_model.email_address, "ullam")
        self.assertEqual(test_model.owner_type, "quidem")
