...
class TestCreateLinkedUserDtoModel(unittest.TestCase):
    ...
    def test_create_linked_user_dto(self):
        ...
        test_model = CreateLinkedUserDto(
            id_project="exercitationem", alias="aut", linked_user_origin_id="qui"
        )
        self.assertEqual(test_model.id_project, "exercitationem")
        self.assertEqual(test_model.alias, "aut")
        self.assertEqual(test_model.linked_user_origin_id, "qui")
