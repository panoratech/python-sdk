...
class TestCreateLinkedUserDtoModel(unittest.TestCase):
    ...
    def test_create_linked_user_dto(self):
        ...
        test_model = CreateLinkedUserDto(
            id_project="voluptas", alias="corrupti", linked_user_origin_id="occaecati"
        )
        self.assertEqual(test_model.id_project, "voluptas")
        self.assertEqual(test_model.alias, "corrupti")
        self.assertEqual(test_model.linked_user_origin_id, "occaecati")
