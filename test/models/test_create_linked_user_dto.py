...
class TestCreateLinkedUserDtoModel(unittest.TestCase):
    ...
    def test_create_linked_user_dto(self):
        ...
        test_model = CreateLinkedUserDto(
            id_project="commodi", alias="magnam", linked_user_origin_id="adipisci"
        )
        self.assertEqual(test_model.id_project, "commodi")
        self.assertEqual(test_model.alias, "magnam")
        self.assertEqual(test_model.linked_user_origin_id, "adipisci")
