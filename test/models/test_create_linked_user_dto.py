...
class TestCreateLinkedUserDtoModel(unittest.TestCase):
    ...
    def test_create_linked_user_dto(self):
        ...
        test_model = CreateLinkedUserDto(
            ...
            linked_user_origin_id="reprehenderit",
        )
        self.assertEqual(test_model.id_project, "autem")
        self.assertEqual(test_model.alias, "necessitatibus")
        self.assertEqual(test_model.linked_user_origin_id, "reprehenderit")
