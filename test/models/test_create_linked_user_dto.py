...
class TestCreateLinkedUserDtoModel(unittest.TestCase):
    ...
    def test_create_linked_user_dto(self):
        ...
        test_model = CreateLinkedUserDto(
            id_project="delectus", alias="voluptates", linked_user_origin_id="molestiae"
        )
        self.assertEqual(test_model.id_project, "delectus")
        self.assertEqual(test_model.alias, "voluptates")
        self.assertEqual(test_model.linked_user_origin_id, "molestiae")
