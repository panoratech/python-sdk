...
class TestCreateLinkedUserDtoModel(unittest.TestCase):
    ...
    def test_create_linked_user_dto(self):
        ...
        test_model = CreateLinkedUserDto(
            id_project="nemo", alias="debitis", linked_user_origin_id="minima"
        )
        self.assertEqual(test_model.id_project, "nemo")
        self.assertEqual(test_model.alias, "debitis")
        self.assertEqual(test_model.linked_user_origin_id, "minima")
