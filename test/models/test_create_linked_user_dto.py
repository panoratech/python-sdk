...
class TestCreateLinkedUserDtoModel(unittest.TestCase):
    ...
    def test_create_linked_user_dto(self):
        ...
        test_model = CreateLinkedUserDto(
            id_project="dolore", alias="praesentium", linked_user_origin_id="qui"
        )
        self.assertEqual(test_model.id_project, "dolore")
        self.assertEqual(test_model.alias, "praesentium")
