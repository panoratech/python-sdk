...
class TestMapFieldToProviderDtoModel(unittest.TestCase):
    ...
    def test_map_field_to_provider_dto(self):
        ...
        test_model = MapFieldToProviderDto(
            linked_user_id="cumque",
            source_provider="7608599981",
            source_custom_field_id="cumque",
            attributeId="ad",
        )
        self.assertEqual(test_model.linked_user_id, "cumque")
        self.assertEqual(test_model.source_provider, "7608599981")
        self.assertEqual(test_model.source_custom_field_id, "cumque")
        self.assertEqual(test_model.attributeId, "ad")
