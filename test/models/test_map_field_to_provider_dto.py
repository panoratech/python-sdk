...
class TestMapFieldToProviderDtoModel(unittest.TestCase):
    ...
    def test_map_field_to_provider_dto(self):
        ...
        test_model = MapFieldToProviderDto(
            linked_user_id="fugit",
            source_provider="5600705161",
            source_custom_field_id="in",
            attributeId="totam",
        )
        self.assertEqual(test_model.linked_user_id, "fugit")
        self.assertEqual(test_model.source_provider, "5600705161")
        self.assertEqual(test_model.source_custom_field_id, "in")
        self.assertEqual(test_model.attributeId, "totam")
