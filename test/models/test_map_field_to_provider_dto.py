...
class TestMapFieldToProviderDtoModel(unittest.TestCase):
    ...
    def test_map_field_to_provider_dto(self):
        ...
        test_model = MapFieldToProviderDto(
            linked_user_id="dolorem",
            source_provider="1450923892",
            source_custom_field_id="cum",
            attributeId="id",
        )
        self.assertEqual(test_model.linked_user_id, "dolorem")
        self.assertEqual(test_model.source_provider, "1450923892")
        self.assertEqual(test_model.source_custom_field_id, "cum")
        self.assertEqual(test_model.attributeId, "id")
