...
class TestMapFieldToProviderDtoModel(unittest.TestCase):
    ...
    def test_map_field_to_provider_dto(self):
        ...
        test_model = MapFieldToProviderDto(
            linked_user_id="quidem",
            source_provider="5789543405",
            source_custom_field_id="soluta",
            attributeId="voluptatum",
        )
        self.assertEqual(test_model.linked_user_id, "quidem")
        self.assertEqual(test_model.source_provider, "5789543405")
        self.assertEqual(test_model.source_custom_field_id, "soluta")
