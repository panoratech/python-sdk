...
class TestMapFieldToProviderDtoModel(unittest.TestCase):
    ...
    def test_map_field_to_provider_dto(self):
        ...
        test_model = MapFieldToProviderDto(
            linked_user_id="dolore",
            source_provider="3716608967",
            source_custom_field_id="saepe",
            attributeId="aliquid",
        )
        self.assertEqual(test_model.linked_user_id, "dolore")
        self.assertEqual(test_model.source_provider, "3716608967")
        self.assertEqual(test_model.source_custom_field_id, "saepe")
        self.assertEqual(test_model.attributeId, "aliquid")
