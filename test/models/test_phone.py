...
class TestPhoneModel(unittest.TestCase):
    ...
    def test_phone(self):
        ...
        test_model = Phone(
            phone_type="minima", phone_number="repellendus", owner_type="deleniti"
        )
        self.assertEqual(test_model.phone_type, "minima")
        self.assertEqual(test_model.phone_number, "repellendus")
