...
class TestPhoneModel(unittest.TestCase):
    ...
    def test_phone(self):
        ...
        test_model = Phone(
            phone_type="pariatur", phone_number="veniam", owner_type="iste"
        )
        self.assertEqual(test_model.phone_type, "pariatur")
        self.assertEqual(test_model.phone_number, "veniam")
        self.assertEqual(test_model.owner_type, "iste")
