...
class TestDefineTargetFieldDtoModel(unittest.TestCase):
    ...
    def test_define_target_field_dto(self):
        ...
        test_model = DefineTargetFieldDto(
            ...
            name="hic",
            object_type_owner="esse",
        )
        self.assertEqual(test_model.data_type, "eveniet")
        self.assertEqual(test_model.description, "repellat")
        self.assertEqual(test_model.name, "hic")
        self.assertEqual(test_model.object_type_owner, "esse")
