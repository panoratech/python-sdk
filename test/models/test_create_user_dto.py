...
class TestCreateUserDtoModel(unittest.TestCase):
    ...
    def test_create_user_dto(self):
        ...
        test_model = CreateUserDto(
            password_hash="molestiae",
            email="culpa",
            last_name="dolor",
            first_name="accusantium",
        )
        self.assertEqual(test_model.password_hash, "molestiae")
        self.assertEqual(test_model.email, "culpa")
        self.assertEqual(test_model.last_name, "dolor")
        self.assertEqual(test_model.first_name, "accusantium")
