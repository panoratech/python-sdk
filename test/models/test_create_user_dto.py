...
class TestCreateUserDtoModel(unittest.TestCase):
    ...
    def test_create_user_dto(self):
        ...
        test_model = CreateUserDto(
            password_hash="expedita",
            email="atque",
            last_name="deleniti",
            first_name="aut",
        )
        self.assertEqual(test_model.password_hash, "expedita")
        self.assertEqual(test_model.email, "atque")
        self.assertEqual(test_model.last_name, "deleniti")
        self.assertEqual(test_model.first_name, "aut")
