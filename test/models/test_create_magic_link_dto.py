...
class TestCreateMagicLinkDtoModel(unittest.TestCase):
    ...
    def test_create_magic_link_dto(self):
        ...
        test_model = CreateMagicLinkDto(
            ...
            alias="fuga",
            email="velit",
            linked_user_origin_id="consequatur",
        )
        self.assertEqual(test_model.id_project, "ipsam")
        self.assertEqual(test_model.alias, "fuga")
        self.assertEqual(test_model.email, "velit")
        self.assertEqual(test_model.linked_user_origin_id, "consequatur")
